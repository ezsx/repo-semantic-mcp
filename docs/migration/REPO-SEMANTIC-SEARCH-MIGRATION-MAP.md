...
- private product-flow specs
- architecture docs
- runtime/operations-flow documents
...
- `apps/repo-semantic-mcp/main.py`
  -> `<source-repo>\apps\repo-semantic-mcp\main.py`

- `apps/repo-semantic-mcp/requirements.txt`
  -> `<source-repo>\apps\repo-semantic-mcp\requirements.txt`

- `apps/repo-semantic-mcp/Dockerfile`
  -> `<source-repo>\apps\repo-semantic-mcp\Dockerfile`

### 7.2 Core package

- `services/repo_semantic/__init__.py`
  -> `<source-repo>\services\repo_semantic\__init__.py`
...
- `<source-repo>\services\repo_semantic\chunkers\*`
...
- `<source-repo>\services\repo_semantic\embeddings\*`

### 7.5 Deploy

- `deploy/repo-semantic-search/.env.example`
  -> `<source-repo>\deploy\repo-semantic-search\.env.example`
...
- `scripts/agents/ensure_repo_semantic_search.ps1`
  -> `<source-repo>\scripts\agents\ensure_repo_semantic_search.ps1`
- `scripts/agents/register_repo_semantic_search.ps1`
  -> `<source-repo>\scripts\agents\register_repo_semantic_search.ps1`

### 7.7 Docs

- `docs/specifications/P1.Z-repo-semantic-search-mcp-specification.md`
  -> `<source-repo>\docs\specifications\P1.Z-repo-semantic-search-mcp-specification.md`
- `docs/migration/REPO-SEMANTIC-SEARCH-MIGRATION-MAP.md`
  -> `<source-repo>\docs\migration\REPO-SEMANTIC-SEARCH-MIGRATION-MAP.md`
...
Цель:
- убрать `legacy_collection_prefix` из generic tool.
...
- **сейчас**: ручной safe landing в `<source-repo>`
